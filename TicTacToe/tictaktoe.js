...
function placeXOrO(squareNumber) {
    ...
    //The .some() method is used to check each element of selectSquare array to
    //see if it contains the square number clicked on.
    if (!selectedSquares.some(element => element === squareNumber)) {
...
//This function utilitize html canvas to draw win lines.
function drawWinLine(coorX1, coorY1, coorX2, coorY2) {
    //This line accesses our html canvas element.
    const canvas = document.getElementById('win-lines');
    //This line gives us access to methods and properties to use on canvas.
    const c = canvas.getContext('2d');
    //This line indicates wherethe start of a lines x axis is.
    let x1 = coorX1,
    ...
    function animateLineDrawing() {
        ...
        //Thiscondition is similar to the one above.
    ...
    function clear() {
        //This line starts our animtion loop.
